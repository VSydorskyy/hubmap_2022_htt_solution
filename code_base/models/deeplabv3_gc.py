...
from .unet_gc import SegmentationModelGC


class DeepLabV3GC(SegmentationModelGC):
    ...
    def __init__(
        ...
        if aux_params is not None:
            self.classification_head = ClassificationHead(in_channels=encoder_out_channels[-1], **aux_params)
        else:
            self.classification_head = None


class DeepLabV3PlusGC(SegmentationModelGC):
