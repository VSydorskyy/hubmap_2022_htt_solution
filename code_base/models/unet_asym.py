...
class UnetDecoderAsymmetric(nn.Module):
    def __init__(
        self,
        encoder_channels,
        decoder_channels,
...
class UnetAsymmetric(SegmentationModel):
    ...
    def __init__(
        ...
        setattr(
            getattr(self.encoder, first_conv_name),
            "stride",
            new_stride,
        )

        self.decoder = UnetDecoderAsymmetric(
