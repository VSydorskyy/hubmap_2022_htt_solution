...
CONFIG = {
    ...
    "exp_name": "unetpp_timmefficientnetb7NS_strongaugs_512_lr1e3_BceDiceFocalIoU_bs32_testscale_HMGTEXAndOldTrainP1_datax8_1ch_masksamplingP05_ConcatDataset_denisx2scales",
    "files_to_save": (glob("code_base/**/*.py") + [__file__] + ["scripts/main_train.py"]),
    "folds": [0, 1, 2, 3, 4],
    "train_function": catalyst_training,
    "train_function_args": {
        "train_dataset_class": HubMapDataset,
        ...
        "add_train_dataset_class": [HubMapDataset],
