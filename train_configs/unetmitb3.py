...
from code_base.forwards import SMPHubMapForward
...
CONFIG = {
    ...
    "exp_name": "unet_mitb3_strongaugs_1024_lr1e4_BceDiceFocalIoU_bs8_testscale_HMGTEXAndOldTrainP1_datax8_1ch_masksamplingP05_ConcatDataset_DenisPseudoScaledV3X16_denisx2scales_datav2_HpaPseudoV2X1",
    ...
    "train_function_args": {
        ...
        "train_dataset_config": {
            "root": ROOT_PATH,
            "pseudo_df_path": "data/hpa_add/v2.csv",
            ...
            "cutmix_transform": lambda : [
                ...
                A.OneOrOther(first=A.CropNonEmptyMaskIfExists(crop_size, crop_size), second=A.RandomCrop(crop_size, crop_size), p=0.5),
            ],
        ...
        #     eta_min=1e-6,
        # ),
        "forward": lambda: SMPHubMapForward(
            {
